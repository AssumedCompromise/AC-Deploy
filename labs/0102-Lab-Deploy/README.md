...
| ![][addlogosm] <br>[&#x1f3e0; Home][HOME] | Prerequisites: [[L0000]] - [[L0101]] -[YOU ARE HERE] <br> Labs: [[L0103]] - [[L0104]] - [[L0105]] - [[L2001]] - [[L2002]] - [[L2003]] - [[L2004]] - [[L2005]] - [[L2006a]] - [[L2006b]] -  [[L2007]] - [[L2008]] - [[L2009]] - [[L2010]] - [[L2011]] - [[L2012]] - [[L2013]] - [[L2014]] - <br>[[&#128210; EvID Ref][evidref]]| 
|--------|:--------|
<!-- DO-NAVTREE-TABLE-END -->

<!-- DO-LAB-TITLE START -->
# L0102 - Lab Deployment 
...
In this lab, participants will deploy a comprehensive lab environment using an Azure ARM template hosted on GitHub. This environment will be utilized in subsequent sessions to demonstrate various cyber attacks, detections, and defenses. The focus of this lab is on the deployment process, ensuring that students have a readied lab environment for the rest of this course.
<!-- DO-LAB-OVERVIEW END -->
...
<!-- DO-LAB-OBJECTIVES START -->
 ...
 &#x1F4AC;  Leaving RDP and SSH Open is Interesting  
 &#x2611;  Deploy a Lab Environment  
 &#x2611;  Document Virtua Machine IP Addresses (Outputs)  
 &#x2611; Document Resource Group Location/Region  
...
## &#x2460; Deploy Your Assumed Compromise Lab Environment
...
The **Outputs** option in the left navigation tree includes the access details you will need for SSH and RDP access into the lab environment. Document these IP addresses, they will be used later in class.
